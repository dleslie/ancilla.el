...
*** Use of non-OpenAI Models

You can use any OpenAI compatible services by customizing the `ancilla-adaptor-chat-api-endpoint` variable, which defaults to "https://api.openai.com/v1/chat/completions".
